...
function fontSize(container, target, minSize, defSize, maxSize, baseUrl) {
	/*Editable settings*/
	var minCaption = "Texto chico"; //title for smallFont button
	var defCaption = "Texto por defecto"; //title for defaultFont button
	var maxCaption = "Texto grande"; //title for largefont button
